...
- **IP**: `192.168.0.12`
- **원격 저장소 경로**: `/Users/mersoom/Dropbox/Dev/CEML_RA`
...
ssh mersoom@Mersoomui-Macmini.local 'source ~/.zshrc 2>/dev/null; conda activate lab-research-agents && cd /Users/mersoom/Dropbox/Dev/CEML_RA/lab-orchestrator && <명령>'
